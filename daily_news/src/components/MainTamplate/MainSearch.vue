<template>
  <div class="mainNews-wrapper">
    <h2 class="mainNews__title">Search news</h2>
    <div class="search">
    <div class="search-form">
        <input type="text" placeholder="Search" v-model="q" v-on:click="onQueryChange">
        <button type="submit" class="search__btn" v-on:click="searchNewsList">
...
<script>
  ...
  methods: {
    ...
    onClickHandler (currentPage)  {
      ...
      this.paramsSearch.page = currentPage;
      this.searchNewsList();
    },
  },
  mounted() {
